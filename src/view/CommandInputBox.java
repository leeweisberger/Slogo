...
public class CommandInputBox extends JFrame
        implements DocumentListener {
     
    private static final String COMMAND_BOX_TITLE = "TypeCommandHere";
    ...
    public static void main(String args[]) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                new CommandInputBox().setVisible(true);
            }
        });
    }
